...
from server.utils.auth_middleware import get_required_user, get_superadmin_user, get_db
...
async def set_default_agent(request_data: dict = Body(...), current_user = Depends(get_superadmin_user)):
    """设置默认智能体ID (仅超级管理员)"""
    try:
